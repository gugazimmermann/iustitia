...
export function Header({ before, main }: HeaderProps) {
  return (
    <div className="flex items-center justify-between w-full px-4 py-2 border-b lg:py-4">
      ...
      <button className="px-4 py-2 text-sm text-white rounded-md bg-purple-500 hover:bg-purple-900 focus:outline-none focus:ring focus:ring-purple-500 focus:ring-offset-1 focus:ring-offset-white">
        View on github
      </button>
    </div>
  );
